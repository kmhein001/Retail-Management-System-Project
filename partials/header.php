<?php
include_once '../config/app_baseurl.php';
...
<head>
  ...
  <link href="../vendors/datatables.net-bs5/css/dataTables.dataTables.css" rel="stylesheet">
  <link href="../vendors/datatables.net-bs5/css/dataTables.bootstrap5.css" rel="stylesheet">
  ...
  <link href="../vendors/@coreui/coreui/dist/css/coreui.min.css" rel="stylesheet">
...
<body>
  ...
  <div class="wrapper d-flex flex-column min-vh-100">
    ...
    <header class="header header-sticky p-0 mb-4">
      <div class="container-fluid px-4 border-bottom" style="margin: 18px 0;">
        <!-- icon menu left -->
        ...
        <ul class="header-nav ms-auto ms-md-0">
          ...
          <!-- icon contrast auto dark and light -->
          <li class="nav-item dropdown">
            <button class="btn btn-link nav-link" type="button" aria-expanded="false" data-coreui-toggle="dropdown">
      ...
      <div class="container-fluid px-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0">
            <li class="breadcrumb-item"><a href="<?= $base_url ?>/index.php" data-coreui-i18n="Home">Home</a>
            </li>