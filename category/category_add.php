...
<li class="breadcrumb-item"><a href="category_list.php" data-coreui-i18n="Category List">Category list</a>
</li>
<li class="breadcrumb-item active"><a href="category_add.php" data-coreui-i18n="Category Add">Add category</a>
</li>
</ol>
</nav>
</div>
...
<div class="body flex-grow-1">
    <div class="container px-2">
        <div class="card mb-4 border border-secondary rounded">
            ...
            <div class="card-header d-flex align-items-center">
                <div class="row w-100 h-100">
                    ...
                    <div class="col-md-6 col-12 d-flex justify-content-start align-items-center">
                        <div>
                            <h3 class="card-title fw-bold fs-4 my-4">Add category</h3>
            ...
            <!-- Card Body -->
            <div class="card-body">
                <form action="category_add_process.php" class="px-3 py-4" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 my-4">
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" rows="5" cols="5"id="desc" name="desc" placeholder="Enter Description" value="<?= htmlspecialchars($row['Description'] ?? '') ?>"></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-check form-switch d-flex align-items-center justify-content-start" id="status-toggle" style="display: none;">
                                <input class="form-check-input me-3" type="checkbox" id="status" name="status"
                                    style="width: 60px; height: 25px;" data-category-id="<?= $row["CategoryID"] ?>"
