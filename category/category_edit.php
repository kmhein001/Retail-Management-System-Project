...
<li class="breadcrumb-item"><a href="category_list.php" data-coreui-i18n="Category ">Category list</a>
</li>
<li class="breadcrumb-item active"><a href="category_edit.php" data-coreui-i18n="Edit Category">Edit Category</a>
</li>
</ol>
</nav>
</div>
    ...
    <div class="container px-2">
        <div class="card mb-4 border border-secondary rounded">
            ...
            <div class="card-header d-flex align-items-center">
                <div class="row w-100 h-100">
                    ...
                    <div class="col-md-6 col-12 d-flex justify-content-start align-items-center">
                        <div>
                            <h3 class="card-title fw-bold fs-4 my-4">Edit Category</h3>
                            <h5 class="text-muted fs-6 mb-4">Manage your Category</h5>
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                $stmt->close();
                ?>
                <form action="./category_update.php" class="px-3 py-4" method="POST" enctype="multipart/form-data">
                    
                    <div class="row g-4">
                       
                        <div class="col-lg-6 col-md-6 col-12 my-4">
                            <div class="d-flex align-items-center justify-content-start" style="height: 100px;">
                                <label for="id" class="form-label fw-bold fs-4 me-3 mt-3">Category ID:</label>
                                <div class="badge bg-info text-white fs-5" id="id_badge">
                                    <?= htmlspecialchars($row['CategoryID'] ?? 'Auto-generated ID') ?>
                                </div>
                                <input type="hidden" id="id" name="id" value="<?= htmlspecialchars($row['CategoryID'] ?? '') ?>">
                            </div>
                        </div>
                       
                        <div class="col-lg-6 col-md-6 col-12 my-4">
                            <div class="mb-3">
                                <label for="name" class="form-label fw-bold fs-4">category Name</label>
                                <input type="text" class="form-control" style="height:60px" id="name" name="name" placeholder="Enter category Name'" value="<?= htmlspecialchars($row['CategoryName'] ?? '') ?>" required>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="image-upload">
                                    ...
                                    $image_path = !empty($row["ImageFile"])
                                        ? (($file_extension === 'svg')
                                            ? "../assets/img/category/svg/" . $row["ImageFile"]
                                            : "../assets/img/category/png/" . $row["ImageFile"])
                                        : "../assets/img/default-placeholder.png";
                                    ?>
                                    <img src="<?= $image_path ?>"
                                        alt="<?= htmlspecialchars($row['categoryName'] ?? 'ImageFile') ?>"
                    ...
                    <div class="row g-4 my-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <a href="category_list.php" class="btn btn-outline-danger fs-5 px-5 py-3" style="border-radius: 6px;">
                                    Cancel
                                </a>
                            </div>
                        </div>
