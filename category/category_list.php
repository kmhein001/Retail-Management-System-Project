...
<li class="breadcrumb-item active"><a href="category_list.php" data-coreui-i18n="Category List">Category list</a>
</li>
</ol>
</nav>
</div>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
                    <!-- Card Title -->
                    <div>
                        <h3 class="card-title my-3 fs-4 fs-md-3">Category List</h3>
                        <h5 class="text-muted my-3 fs-6 fs-md-5">Manage your Category</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="col-md-6 col-12 mb-3 mb-md-0 d-flex justify-content-start">
                            <a class="btn btn-primary d-flex align-items-center justify-content-center align-middle"
                                style="width: 250px; height: 60px; font-size: 18px;" href="category_add.php">
                                        ...
                                        ?>
                                            <tr>
                                                <td class="align-middle text-center">
                                                    <input type="checkbox" name="selected_ids[]" value="<?= $row["CategoryID"] ?>" class="rowCheckbox">
                                                </td>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    if ($file_extension === 'svg') {
                                                        $image_path = "../assets/img/Category/svg/" . $row["ImageFile"];
                                                    } elseif ($file_extension === 'png') {
                                                        $image_path = "../assets/img/Category/png/" . $row["ImageFile"];
                                                    } else {
                                                        // Fallback image or error handling
                                                        $image_path = "../assets/img/category/default.png"; // Use a default image if the type is unknown
                                                    }
                                                    ?>
                                                    <img src="<?= $image_path ?>"
                                                        alt="<?= isset($row['CategoryName']) && !empty($row['CategoryName']) ? $row['CategoryName'] : $row['ImageFile'] ?>"
                                                ...
                                                <td class="align-middle text-center">
                                                    <div class="form-check form-switch d-flex justify-content-center align-items-center">
                                                        ...
                                                        <input class="form-check-input status-toggle"
                                                            type="checkbox" data-category-id="<?= $row["CategoryID"] ?>"
                                                ...
                                                <td class="align-middle text-center">
                                                    <div class="btn-group d-flex flex-column flex-sm-row justify-content-center">
                                                        <!-- Edit Icon -->
                                                        <a class="btn btn-outline-info me-2 mb-2 mb-sm-0" href="<?= $base_url ?>/category/category_edit.php?id=<?= $row['CategoryID'] ?>">
                                                            <svg class="icon" style="width:30px;height:30px;">
                                                                <use xlink:href="../vendors/@coreui/icons/svg/free.svg#cil-description"></use>
                                                            </svg>
                                                        </a>
                                                        <!-- Delete Icon -->
                                                        <a href="category_delete.php?id=<?= $row['CategoryID'] ?>" class="btn btn-outline-danger mb-2 mb-sm-0" onclick="return confirm(\'Are you sure you want to delete this category?\');">
                                                            <svg class="icon" style="width:30px;height:30px;">
