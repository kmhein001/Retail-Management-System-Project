!(function (e, t) {
  ...
  class t {
    ...
    forward(e, t, s, i) {
      return i && !this.debug
        ? null
        : ("string" == typeof e[0] && (e[0] = `${s}${this.prefix} ${e[0]}`),
          this.logger[t](e));
    }
    create(e) {
    ...
    p = (e, t, s) => {
      ...
      for (; void 0 === a.obj && r.length; )
        (n = `${r[r.length - 1]}.${n}`),
          ...
          (a = h(e, r, Object)),
          a && a.obj && void 0 !== a.obj[`${a.k}.${n}`] && (a.obj = void 0);
      a.obj[`${a.k}.${n}`] = s;
    },
    g = (e, t) => {
  ...
  const f = (e) =>
    "string" == typeof e ? e.replace(/[&<>"'\/]/g, (e) => d[e]) : e;
  const m = [" ", ",", "?", "!", ";"],
    y = new (class {
      constructor(e) {
        (this.capacity = e),
  ...
  class x extends i {
    ...
    getResource(e, t, s) {
      ...
      return (
        ...
        a || !n || "string" != typeof s
          ? a
          : v(this.data && this.data[e] && this.data[e][t], s, o)
      );
    }
    addResource(e, t, s, i) {
      let o =
  ...
  class O extends i {
    ...
    extractFromKey(e, t) {
      ...
      void 0 === s && (s = ":");
      const i =
        void 0 !== t.keySeparator ? t.keySeparator : this.options.keySeparator;
      ...
      if (n && !r) {
        ...
        const n = e.split(s);
        (s !== i || (s === i && this.options.ns.indexOf(n[0]) > -1)) &&
          (o = n.shift()),
          (e = n.join(i));
      }
    ...
    translate(e, t, s) {
      ...
      let g = p && p.res;
      const u = (p && p.usedKey) || n,
        c = (p && p.exactUsedKey) || n,
        d = Object.prototype.toString.apply(g),
      ...
      if (
        ...
        ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) <
          0 &&
        ("string" != typeof f || !Array.isArray(g))
      ) {
        if (!t.returnObjects && !this.options.returnObjects) {
          ...
          const e = this.options.returnedObjectHandler
            ? this.options.returnedObjectHandler(u, g, { ...t, ns: r })
            : `key '${n} (${this.language})' returned an object instead of string.`;
          return i
            ? ((p.res = e), (p.usedParams = this.getUsedParamsDetails(t)), p)
            : e;
        }
        if (o) {
          const e = Array.isArray(g),
            s = e ? [] : {},
            i = e ? c : u;
          for (const e in g)
            if (Object.prototype.hasOwnProperty.call(g, e)) {
              const n = `${i}${o}${e}`;
              (s[e] = this.translate(n, { ...t, joinArrays: !1, ns: r })),
                s[e] === n && (s[e] = g[e]);
            }
          g = s;
        }
      } else if (m && "string" == typeof f && Array.isArray(g))
        (g = g.join(f)), g && (g = this.extendTranslation(g, e, t, s));
      else {
        let i = !1,
          r = !1;
        const h = void 0 !== t.count && "string" != typeof t.count,
          u = O.hasDefaultValue(t),
          ...
          m =
            ...
            t[`defaultValue${d}`] ||
            t.defaultValue;
        !this.isValidLookup(g) && u && ((i = !0), (g = m)),
          this.isValidLookup(g) || ((r = !0), (g = n));
        const y =
        ...
        if (r || i || v) {
          ...
          const i = (e, s, i) => {
            ...
            this.options.missingKeyHandler
              ? this.options.missingKeyHandler(e, a, s, o, v, t)
              : this.backendConnector &&
                this.backendConnector.saveMissing &&
                this.backendConnector.saveMissing(e, a, s, o, v, t),
              this.emit("missingKey", e, a, s, g);
          };
        ...
        (g = this.extendTranslation(g, e, t, p, s)),
          r &&
            g === n &&
          ...
          (r || i) &&
            ...
            (g =
              "v1" !== this.options.compatibilityAPI
                ? this.options.parseMissingKeyHandler(
                    this.options.appendNamespaceToMissingKey ? `${a}:${n}` : n,
                    i ? g : void 0
                  )
                : this.options.parseMissingKeyHandler(g));
      }
      return i
        ? ((p.res = g), (p.usedParams = this.getUsedParamsDetails(t)), p)
        : g;
    }
          ...
          h.forEach((e) => {
            this.isValidLookup(t) ||
              ...
              !S[`${c[0]}-${e}`] &&
                ...
                ((S[`${c[0]}-${e}`] = !0),
                this.logger.warn(
                  `key "${s}" for languages "${c.join(
                    ", "
                  )}" won't get resolved as namespace "${n}" was not yet loaded`,
              ...
              c.forEach((s) => {
                ...
                if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                  this.i18nFormat.addLookupKeys(n, l, s, e, r);
                else {
                  let e;
                  ...
                  if (
                    (p &&
                      ...
                      r.ordinal &&
                        0 === e.indexOf(i) &&
                        n.push(l + e.replace(i, this.options.pluralSeparator)),
                      g && n.push(l + t)),
                    u)
                  ) {
                    ...
                    n.push(s),
                      p &&
                        ...
                        r.ordinal &&
                          0 === e.indexOf(i) &&
                          n.push(
                            s + e.replace(i, this.options.pluralSeparator)
                          ),
                        g && n.push(s + t));
                  }
                }
                ...
                for (; (a = n.pop()); )
                  this.isValidLookup(t) ||
                    ((i = a), (t = this.getResource(s, e, a, r)));
              }));
          });
        }),
    ...
    getUsedParamsDetails() {
      ...
      let i = s ? e.replace : e;
      if (
        (s && void 0 !== e.count && (i.count = e.count),
        this.options.interpolation.defaultVariables &&
    ...
    constructor(e) {
      ...
      (this.languageUtils = e),
        ...
        (this.options.compatibilityJSON &&
          !C.includes(this.options.compatibilityJSON)) ||
  ...
  class F {
    ...
    init() {
      ...
      (this.escape = void 0 !== t ? t : f),
        ...
        (this.nestingPrefix = g ? c(g) : u || c("$t(")),
        (this.nestingSuffix = d ? c(d) : m || c(")")),
    ...
    interpolate(e, t, s, i) {
        ...
        h = (e) => {
          if (e.indexOf(this.formatSeparator) < 0) {
            ...
            return this.alwaysFormat
              ? this.format(o, void 0, s, { ...i, ...t, interpolationkey: e })
              : o;
          }
      ...
      return (
        [
          { regex: this.regexpUnescape, safeValue: (e) => I(e) },
          {
            regex: this.regexp,
    ...
    nest(e, t) {
      ...
      for (; (s = this.nestingRegexp.exec(e)); ) {
        ...
        if (
          ((i = t(a.call(this, s[1].trim(), o), o)),
          i && s[0] === e && "string" != typeof i)
        )
          return i;
  ...
  class M extends i {
    ...
    init() {
      ...
      const n = U();
      (this.options = { ...n, ...this.options, ...T(t) }),
        "v1" !== this.options.compatibilityAPI &&
          (this.options.interpolation = {
            ...n.interpolation,
            ...this.options.interpolation,
    ...
    loadResources(e) {
      ...
      if (
        ...
        this.options.preload && this.options.preload.forEach((e) => i(e)),
    ...
    getFixedT(e, t, s) {
      ...
      const o = function (e, t) {
        ...
        (n.lng = n.lng || o.lng),
          ...
          (n.ns = n.ns || o.ns),
          "" !== n.keyPrefix && (n.keyPrefix = n.keyPrefix || s || o.keyPrefix);
        const h = i.options.keySeparator || ".";
        let p;
        return (
          (p =
            n.keyPrefix && Array.isArray(e)
              ? e.map((e) => `${n.keyPrefix}${h}${e}`)
              : n.keyPrefix
              ? `${n.keyPrefix}${h}${e}`
              : e),
          i.t(p, n)
    ...
    loadLanguages(e, t) {
      ...
      const i = this.options.preload || [],
        n = e.filter(
          (e) =>
            i.indexOf(e) < 0 && this.services.languageUtils.isSupportedCode(e)
        );
      return n.length
    ...
    cloneInstance() {
      ...
      return (
        ...
        s &&
          ((o.store = new x(this.store.data, i)),
          (o.services.resourceStore = o.store)),
        (o.translator = new O(o.services, i)),
