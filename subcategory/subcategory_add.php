...
<li class="breadcrumb-item"><a href="subcategory_list.php" data-coreui-i18n="Subcategory List">Subcategory list</a>
</li>
<li class="breadcrumb-item active"><a href="subcategory_add.php" data-coreui-i18n="Subcategory Add">Add Subcategory</a>
</li>
</ol>
</nav>
</div>
...
<div class="body flex-grow-1">
    <div class="container px-2">
        <div class="card mb-4 border border-secondary rounded">
            ...
            <div class="card-header d-flex align-items-center">
                <div class="row w-100 h-100">
                    ...
                    <div class="col-md-6 col-12 d-flex justify-content-start align-items-center">
                        <div>
                            <h3 class="card-title fw-bold fs-4 my-4">Add Subcategory</h3>
                            <h5 class="text-muted fs-6 mb-4">Manage your Subcategory</h5>
                        </div>
                    </div>
            ...
            <!-- Card Body -->
            <div class="card-body">
                <form action="subcategory_add_process.php" class="px-3 py-4" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <div class="form-check form-switch d-flex align-items-center justify-content-start" id="status-toggle" style="display: none;">
                                <input class="form-check-input me-3" type="checkbox" id="status" name="status"
                                    style="width: 60px; height: 25px;" data-subcategory-id="<?= $row["SubcategoryID"] ?>"
