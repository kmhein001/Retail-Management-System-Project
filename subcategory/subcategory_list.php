        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
                    <!-- Card Title -->
                    <div>
                        <h3 class="card-title my-3 fs-4 fs-md-3">Sub Category List</h3>
                        <h5 class="text-muted my-3 fs-6 fs-md-5">Manage your Sub Category</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <table id="General_Auto_Table" class="table table-striped table-bordered border-warning my-4">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Subcategory Code</th>
                                        ...
                                        ?>
                                            <tr>
                                                <td class="align-middle text-center">
                                                    <input type="checkbox" name="selected_ids[]" value="<?= $row["SubcategoryID"] ?>" class="rowCheckbox">
                                                </td>
                                                <td class="align-middle text-center"><?= $row["SubcategoryID"] ?></td>
                                                <td class="align-middle text-center"><?= $row["SubcategoryName"] ?></td>
                                                <td class="align-middle text-center"><?= $row["SubcategoryCode"] ?></td>
                                                <td class="align-middle text-center"><?= $row["CategoryCode"] ?></td>
                                                <td class="align-middle text-center">
                                                    <?php
                                                    ...
                                                    if ($file_extension === 'svg') {
                                                        $image_path = "../assets/img/subcategory/svg/" . $row["ImageFile"];
                                                    } elseif ($file_extension === 'png') {
                                                        $image_path = "../assets/img/subcategory/png/" . $row["ImageFile"];
                                                    } else {
                                                        // Fallback image or error handling
                                                        $image_path = "../assets/img/subcategory/default.png"; // Use a default image if the type is unknown
                                                    }
                                                    ?>
                                                    <img src="<?= $image_path ?>"
                                                        alt="<?= isset($row['SubcategoryName']) && !empty($row['SubcategoryName']) ? $row['SubcategoryName'] : $row['ImageFile'] ?>"
                                                ...
                                                <td class="align-middle text-center">
                                                    <div class="form-check form-switch d-flex justify-content-center align-items-center">
                                                        ...
                                                        <input class="form-check-input status-toggle"
                                                            type="checkbox" data-subcategory-id="<?= $row["SubcategoryID"] ?>"
                                                ...
                                                <td class="align-middle text-center">
                                                    <div class="btn-group d-flex flex-column flex-sm-row justify-content-center">
                                                        <!-- Edit Icon -->
                                                        <a class="btn btn-outline-info me-2 mb-2 mb-sm-0" href="<?= $base_url ?>/subcategory/subcategory_edit.php?id=<?= $row['SubcategoryID'] ?>">
                                                            <svg class="icon" style="width:30px;height:30px;">
                                                                <use xlink:href="../vendors/@coreui/icons/svg/free.svg#cil-description"></use>
                                                            </svg>
                                                        </a>
                                                        <!-- Delete Icon -->
                                                        <a href="subcategory_delete.php?id=<?= $row['SubcategoryID'] ?>" class="btn btn-outline-danger mb-2 mb-sm-0" onclick="return confirm(\'Are you sure you want to delete this subcategory?\');">
                                                            <svg class="icon" style="width:30px;height:30px;">
